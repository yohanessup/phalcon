...
if ($serverUri == '/phalcon/') {

    /**
     * Displaying view data render page (get data from database)
     * Default URL displays the data result of the "employees" table from "employee" database
     */

    $app->get(
        "/",
        [
            new \PhalconRest\Controllers\PublicController(),
            "employeesAction"
